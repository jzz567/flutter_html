...
class BlockExtendedText extends StatelessWidget {
...
class HtmlRichTextParser extends StatelessWidget {
  ...
  static get _supportedElements =>
      List()
        ..addAll(_supportedStyleElements)..addAll(
          _supportedSpecialtyElements)..addAll(_supportedBlockElements);
    ...
    if (node is dom.Text) {
      ...
      if (parseContext.parentElement == null) {
        ...
        if (treatLikeBlock) {
          ...
          parseContext.rootWidgetList.add(BlockExtendedText(
            child: ExtendedText.rich(span, selectionEnabled: true),
            shrinkToFit: shrinkToFit,
          ));
        }
      ...
      // handle block elements
        ...
        switch (node.localName) {
          ...
          default:
            ...
            BlockExtendedText blockText = BlockExtendedText(
              shrinkToFit: shrinkToFit,
